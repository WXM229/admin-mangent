<template>
  <div class="page">
    ...
    <div style="margin-top: 20px">
      <draggable v-model="dragList" group="site" animation="300" dragClass="dragClass" ghostClass="ghostClass" chosenClass="chosenClass">
        <transition-group>
          <el-card style="margin-top: 10px" class="item" v-for="item in dragList" :key="item.typeId">
            <div slot="header" class="clearfix">
              <span>{{item.type}}</span>
            </div>
            <draggable v-model="item.data" :group="item.name" animation="300" dragClass="dragClass"  ghostClass="ghostClass" chosenClass="chosenClass">
              <transition-group>
